...
export function validateTimeAndCursor(showSeconds, returnEmptyString, value, defaultValue, colon, cursorPosition) {
    if (showSeconds === void 0) { showSeconds = false; }
    if (returnEmptyString === void 0) { returnEmptyString = false; }
...
var TimeField = /** @class */ (function (_super) {
    ...
    function TimeField(props) {
        ...
        var _returnEmptyString = Boolean(props.returnEmptyString);
        ...
        var validatedTime = validateTimeAndCursor(_showSeconds, _returnEmptyString, _this.props.value, _defaultValue, _colon)[0];
        _this.state = {
            value: validatedTime,
            _colon: _colon,
            _showSeconds: _showSeconds,
            _returnEmptyString: _returnEmptyString,
    ...
    TimeField.prototype.componentDidUpdate = function (prevProps) {
        if (this.props.value !== prevProps.value) {
            var validatedTime = validateTimeAndCursor(this.state._showSeconds, this.state._returnEmptyString, this.props.value, this.state._defaultValue, this.state._colon)[0];
            this.setState({
                value: validatedTime
            });
        }
    ...
    TimeField.prototype.onInputChange = function (event, callback) {
        ...
        var isDelete = inputValue.length < oldValue.length;
        ...
        var returnEmptyString = this.state._returnEmptyString;
        ...
        var _a = validateTimeAndCursor(this.state._showSeconds, returnEmptyString, newValue, oldValue, colon, newPosition), validatedTime = _a[0], validatedCursorPosition = _a[1];
    ...
    TimeField.prototype.render = function () {
        ...
        var _a = this.props, onChange = _a.onChange, style = _a.style, showSeconds = _a.showSeconds, input = _a.input, colon = _a.colon, returnEmptyString = _a.returnEmptyString, props = __rest(_a, ["onChange", "style", "showSeconds", "input", "colon", "returnEmptyString"]); //eslint-disable-line no-unused-vars
